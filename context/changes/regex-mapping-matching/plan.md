...
- [x] 4.1 Add most-specific / case-insensitive / exact-beats-regex / default-last tests — ad4b560
- [x] 4.2 Add inject-on-load test (in-memory, disk unchanged) — ad4b560
- [x] 4.3 Update hand-built `Config` tests to call `buildMatchers()` — ad4b560
- [x] 4.4 `mage test`, `mage lint`, `mage govulncheck` pass — ad4b560
