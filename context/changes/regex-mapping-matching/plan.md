...
- [ ] 3.1 Remove `auto` from starter.yaml; fix comment
- [ ] 3.2 Update `TestStarterTemplate_FallbackChainOrdering` (drop `auto`, new comment)
- [ ] 3.3 Render protected badge + disable delete for `default` (table + drawer)
- [ ] 3.4 Test: `default` row flagged protected
