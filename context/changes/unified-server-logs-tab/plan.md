...
- [ ] 3.1 `go build -o freedius .` produces working binary
- [ ] 3.2 `go test ./...` passes (dispatch/init/serve tests removed)
- [ ] 3.3 `./freedius --version` exits 0, prints version
- [ ] 3.4 `./freedius --help` exits 0, prints usage
- [ ] 3.5 `go vet ./...` clean
