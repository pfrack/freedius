...
.PHONY: test vet build ci tidy run verbose lint lint-static lint-golangci manual-test install-hooks format format-changed install-goimports install-golines install-gci generate-check
